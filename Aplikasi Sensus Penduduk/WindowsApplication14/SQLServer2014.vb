...
Module SQLServer2014
    Public koneksiSQL As SqlConnection

    Sub konekdatabase()
        Try
            koneksiSQL = New SqlConnection("Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\Data Rauf non Enkripsi Program\Database Sql Server 2014\db_sensus_penduduk_bootcamp_arcademy.mdf;Integrated Security=True;Connect Timeout=30")
            koneksiSQL.Open()
